...
ActiveRecord::Schema.define(:version => 20140410153635) do
  create_table "payu_latam_payment_methods", :force => true do |t|
    t.string   "kb_payment_method_id"      # NULL before Kill Bill knows about it
    t.string   "token"                     # payu_latam id
  ...
  add_index(:payu_latam_payment_methods, :kb_account_id)
  add_index(:payu_latam_payment_methods, :kb_payment_method_id)

  create_table "payu_latam_transactions", :force => true do |t|
    t.integer  "payu_latam_response_id",  :null => false
    t.string   "api_call",                       :null => false
    t.string   "kb_payment_id",                  :null => false
    t.string   "kb_payment_transaction_id",      :null => false
    t.string   "transaction_type",               :null => false
    t.string   "payment_processor_account_id"
    t.string   "txn_id"                          # payu_latam transaction id
    # Both null for void
  ...
  add_index(:payu_latam_transactions, :kb_payment_id)

  create_table "payu_latam_responses", :force => true do |t|
    t.string   "api_call",          :null => false
