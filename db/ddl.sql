CREATE TABLE `payu_latam_payment_methods` (
  ...
  PRIMARY KEY (`id`),
  KEY `index_payu_latam_payment_methods_on_kb_account_id` (`kb_account_id`),
  KEY `index_payu_latam_payment_methods_on_kb_payment_method_id` (`kb_payment_method_id`)
) ENGINE=InnoDB CHARACTER SET utf8 COLLATE utf8_bin;

CREATE TABLE `payu_latam_transactions` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `payu_latam_response_id` int(11) NOT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `index_payu_latam_transactions_on_kb_payment_id` (`kb_payment_id`)
) ENGINE=InnoDB CHARACTER SET utf8 COLLATE utf8_bin;

CREATE TABLE `payu_latam_responses` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `api_call` varchar(255) NOT NULL,
